<template>
    <div class="h-full flex flex-col md:flex-row gap-4">
        ...
        <!-- Game Over Modal -->
        <div v-if="showGameOverModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
            <div
                ...
                <div class="flex gap-3 mt-2">
                    <button class="flex-1 py-2 rounded-full text-sm font-semibold bg-emerald-500 text-white"
            ...
            if (move) {
                ...
                if (chess.isGameOver()) {
                    if (chess.isCheckmate()) {
                        ...
                        winnerColor.value = null; // TODO: Extend later for stalemate etc!
                    }
